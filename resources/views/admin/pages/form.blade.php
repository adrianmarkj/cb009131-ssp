...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 bg-white p-4">
            <form action="{{ $model->id ? route('admin.pages.update', $model->id) : route('admin.pages.store') }}" method="POST" enctype="multipart/form-data">
                @if ($model->id)
                    @method('PUT')
                @endif
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <x-form-select id="category_id" name="category_id" label="Page Category" value="{{ $model->category_id }}"
