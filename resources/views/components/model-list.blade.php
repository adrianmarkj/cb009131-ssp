            ...
            <tr>
                ...
                @foreach ($columns as $column)
                    <td>
                        @if ($column === 'status')
                        @if ($model->{$column})
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-success" fill="none" viewBox="0 0 24 24" style="height:20px;" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        @else
                        <svg xmlns="http://www.w3.org/2000/svg" class="text-danger" fill="none" viewBox="0 0 24 24" style="height:20px;" stroke="currentColor" stroke-width="2">
